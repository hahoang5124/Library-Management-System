                        ...
                        <div class="py-5">
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-auto d-flex">
                                    <button type="submit" class="btn btn-primary" name="submit" id="submit" >Đăng</button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <textarea id="form-product/description" name="mtchitiet"
                                                    class="sa-quill-control form-control" rows="8"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card mt-5">
                                            ...
                                            <div class="row g-4">
                                                <div class="col">
                                                    <label for="form-product/price"
                                                        ...
                                                        class="form-control" id="form-product/price" name="price" value="1499" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
